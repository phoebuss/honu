...
include $$(_RULESMK)
$$(call cleanup_local_var)
$$(call stack_pop,D_STACK)
D :=$$(firstword $$(D_STACK))
endef

LOCAL_VAR := DIRS TARGET TYPE SRCS OBJS DEPS EXPORT CFLAGS LDFLAGS INCLUDES
cleanup_local_var = $(foreach _VAR,$(LOCAL_VAR),$(eval undefine $(_VAR)))
...
register_target = $(eval $(call _register_target))
define _register_target
